...
async function Page() {
    ...
    throw new Error("I am an Error captured inside a server component");
}
...
/* harmony import */ var next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(next_dist_compiled_react_server_dom_webpack_server_browser__WEBPACK_IMPORTED_MODULE_7__);
    ...
    const tree = {
      ...
      children: [
        ...
        {
      children: ['', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 480)), "/workspaces/sentry-nextjs-vercel-testproject/app/error/page.tsx"]}]
    },
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4226)), "/workspaces/sentry-nextjs-vercel-testproject/app/error/layout.tsx"],
        }
      ]
    },
        {
...
'head': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 308)), "/workspaces/sentry-nextjs-vercel-testproject/app/head.tsx"],
    ...
    const pages = ["/workspaces/sentry-nextjs-vercel-testproject/app/error/page.tsx"]
...
var __webpack_exports__ = __webpack_require__.X(0, [318,108], () => (__webpack_exec__(4589)));
