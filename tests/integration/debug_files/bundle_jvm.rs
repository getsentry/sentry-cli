...
fn command_bundle_jvm_fails_out_is_file() {
    let testcase_cwd = "tests/integration/_cases/debug_files/debug_files-bundle-jvm-output-is-file.in/";
...
fn command_bundle_jvm_input_dir_empty() {
    let testcase_cwd = "tests/integration/_cases/debug_files/debug_files-bundle-jvm-input-dir-empty.in/";
    let testcase_cwd_path = std::path::Path::new(testcase_cwd);
    if testcase_cwd_path.exists() {
        remove_dir_all(testcase_cwd_path).unwrap();
    }
...
fn command_bundle_jvm() {
    let testcase_cwd_path =
        "tests/integration/_cases/debug_files/debug_files-bundle-jvm.in/";
