...
pub fn execute(matches: &ArgMatches) -> Result<()> {
    ...
    //     let parent_path = Path::new("/Users/adinauer/dev/debug/");
    //     // let filename = canonical_path.file_name().unwrap();
    //     let filename = OsStr::new("heyalex.test");
    //
    ...
    //
    //     let object = fs::read_to_string(Path::new("/Users/adinauer/dev/debug/no-sentry.full.log"));
    //     match object {
    //         Ok(content) => {
