...
use crate::api::{
    Api, NewRelease, NoneReleaseInfo, OptionalReleaseInfo, ReleaseStatus, UpdatedRelease,
};
...
pub fn make_command(command: Command) -> Command {
    command.about("Manage releases on Sentry.")
        ...
        .subcommand(crate::commands::deploys::make_command(Command::new("deploys")).version_arg().hide(true))
