...
- (releases) Resolve git remote name to URL in `releases set-commits --local` so commits are associated with the correct repository ([#3254](https://github.com/getsentry/sentry-cli/issues/3254))
